...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        {
			return AttachIsClimbObject() || (grabAttachMechanic == GrabAttachType.Static); // only one at the moment
        }
        ...
        {
			return (grabAttachMechanic == GrabAttachType.Rotator_Track) || (grabAttachMechanic == GrabAttachType.Static);
        }
